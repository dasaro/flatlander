...
| Pregnant women color cue | Part I, Section 4 (women-specific social treatment context) | Implementation assumption / extrapolation | Women with active pregnancy render in a distinct color for quick state inspection | `/Users/fdasaro/Desktop/Flatlander/src/render/canvasRenderer.ts` pregnancy color override | No separate toggle; shown in God-view entities | Manual visual verification; pregnancy state source covered in `/Users/fdasaro/Desktop/Flatlander/tests/reproduction.test.ts` |
