...
export const DEFAULT_WORLD_CONFIG: WorldConfig = {
  ...
  policyTriggerIrregularShare: 0.07,
  policyTriggerIrregularDelta: 0.012,
  policyTriggerOvercrowding: 1.15,
  policyTriggerOvercrowdingDelta: 0.04,
  policyTriggerPersistenceTicks: 40,
  policyWarmupTicks: 600,
  policyAgitationTicks: 520,
  policySuppressionTicks: 760,
  policyCooldownTicks: 980,
  ...
  neoTherapySurvivalProbability: 0.26,
