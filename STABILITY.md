...
3. Run `npm run sim:v1` when evaluating readiness for a future `1.0.0` release.
4. The harness must pass its configured thresholds (oscillation + diversity + rank persistence).
